...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Halaman Verifikasi') }}</h1>
            ...
            <div class="col-lg-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p>Bukti Pendaftaran Kampus Luar Negeri <br>
                        ...
                        <p class="font-italic font-semibold">Surat Kuasa (Hanya untuk Diambil langsung oleh Orang
                            lain)<br>
                            <a href="Mengarah ke filepath surat" target=”_blank”
                                class="btn btn-sm btn-primary btn-icon-split" aria-hidden="true"><span
                                    class="icon text-light">
