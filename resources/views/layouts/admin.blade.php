...
" href="{{ route('home') }}">
            ...
            <!-- Nav Item - Formulir -->
            <li class="nav-item {{ Nav::isRoute('formulir.ijazah') }} {{ Nav::isRoute('formulir.transkrip') }}">
                <a class="nav-link collapsed" href="{{ route('formulir.ijazah') }}" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <li class="nav-item {{ Nav::isRoute('permohonan') }}">
