            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <p class="ms-auto">Surat Permohonan Legalisir <br><a
                    href="http://stis.ac.id/media/source/1.%20surat%20permohonan%20legalisir.pdf" target=”_blank”
                    class="btn btn-sm btn-primary btn-icon-split" aria-hidden="true"><span class="icon text-light">
